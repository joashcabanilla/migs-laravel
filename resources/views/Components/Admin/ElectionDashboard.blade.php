    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="card card-primary card-outline elevation-2 p-2">
                <div class="row">
                    <div class="col-12">
                        <h5 class="font-weight-bold mb-0">PER BRANCH</h5>
                    </div>
                    <div class="col-12">
        ...
        @foreach($positionList as $position)
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card card-primary card-outline elevation-2 p-2">
                    <div class="row">
                        <div class="col-12">
                            <h5 class="font-weight-bold mb-0">{{strtoupper($position->Description)}}</h5>
                        </div>
                        <div class="col-12">
                            <div class="chart mt-3">
                                <canvas class="{{strtoupper(str_replace(' ','',$position->Description))}}" style="width: 100%; height: 300px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div> 
