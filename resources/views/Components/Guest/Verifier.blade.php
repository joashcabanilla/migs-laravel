        ...
        <div class="card elevation-2 p-3 mt-4 main-card">
            <div class="row">
                ...
                <div class="col-12 d-flex justify-content-center mt-2">
                    ...
                    <h6 class="font-weight-bold m-0 bg-info rounded p-1">DECEMBER 29, 2025</h6>
                </div>
                ...
                <div class="col-12 mt-4">
                    ...
                    <h5 class="text-light">PARA SA MGA KAMAY-ARI NA BUMOTO AT NAGPA-REHISTRO ONLINE ANG INYONG MGA <b class="text-warning">GA ITEMS</b> AY MAAARING I-CLAIM  MULA <b class="text-warning">MARCH 9, 2026</b> HANGGANG <b class="text-warning">MARCH 13, 2026</b> LAMANG.</h5>
                ...
                <div class="col-12 mt-2">
                    <h5 class="text-light">PARA NAMAN SA MGA KASAPI NA NASA IBANG LUGAR O HINDI MAKAKAPUNTA, MAAARING IPAKUHA ANG INYONG MGA <b class="text-warning">GA ITEMS.</b> MAGDALA LAMANG NG <b class="text-warning">AUTHORIZATION LETTER</b> AT <b class="text-warning">PHOTO COPY</b> NG INYONG VALID ID.</h5>

                    <h5 class="text-warning font-weight-bold mb-0 mt-4">MIGS verifier records as of February 28, 2026.</h5>
                </div>
                <div class="col-12">
                    <hr class="bg-light" />
                </div>
