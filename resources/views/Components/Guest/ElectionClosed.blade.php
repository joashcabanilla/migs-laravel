...
@section('content')
    <div class="hold-transition d-flex justify-content-center mt-5 m-3">
        <div class="card elevation-3">
            ...
            <div class="card-body">
                <h1 class="font-weight-bold text-monospace text-center">The 50th General Assembly</h1>
                <h1 class="font-weight-bold text-monospace text-center" style="color:purple">ONLINE ELECTION IS OFFICIALLY CLOSED.</h1> 
                {{-- <h1 class="font-weight-bold text-monospace text-center">The MIGS Verifier will open on</h1>
                <h1 class="font-weight-bold text-monospace text-center" style="color:purple">March 2, 2026.</h1>  --}}
