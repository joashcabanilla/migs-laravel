<?php
    ...
    if(!empty($memberList)){
        ...
        $pdf->addTextWrap($startW+$pdf->C2P(17), $startH+$pdf->C2P(0.18), $pdf->C2P(3.6), $fontSize, "<b>DATE</b>",'center');
        ...
        foreach($memberList as $member){
            if($startH < 80){
                ...
                $fontSize = 9;
                $pdf->addTextWrap($startW, $startH+$pdf->C2P(0.18), $pdf->C2P(2.5), $fontSize,$member["Pbno"],'center');
                
                $pdf->addTextWrap($startW+$pdf->C2P(2.5), $startH+$pdf->C2P(0.18), $pdf->C2P(2.5), $fontSize, $member["MemberId"],'center');
                
                $pdf->addTextWrap($startW+$pdf->C2P(5.1), $startH+$pdf->C2P(0.18), $pdf->C2P(9), $fontSize,$member["Name"],'left');
        
                $pdf->addTextWrap($startW+$pdf->C2P(14), $startH+$pdf->C2P(0.18), $pdf->C2P(3), $fontSize, $member["VoteMethod"],'center');
        
                $pdf->addTextWrap($startW+$pdf->C2P(17), $startH+$pdf->C2P(0.18), $pdf->C2P(3.6), $fontSize, $member["DateTime"],'center');
            }else{
                //left corner
                $pdf->line($startW,$startH+$extend,$startW,$startH-$rowH-$extend);
                //pbno divider
