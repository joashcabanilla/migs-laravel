                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu dropdown-menu-right pt-0 pb-0">
                            <div class="bg-primary dropdown-item">
                                <a class="font-weight-bold text-center mt-0 mb-0">{{Auth::user()->FirstName . " " . Auth::user()->LastName}}</a>
                                <p class="font-weight-bold text-monospace text-center m-0">{{$UserTypeList[Auth::user()->UserType]}}</p>
                            </div>
